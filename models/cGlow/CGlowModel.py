# from https://github.com/yolu1055/conditional-glow

import torch
import torch.nn as nn
import numpy as np
import models.cGlow.modules as modules
...
class CondGlowModel(nn.Module):
    ...
    def __init__(self, x_size, y_size, x_hidden_channels, x_hidden_size, y_hidden_channels, flow_depth, num_levels, learn_top, y_bins):
        super().__init__()
