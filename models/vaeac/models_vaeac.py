# modified from https://github.com/tigvarts/vaeac/blob/master/celeba_model/model.py

from torch import nn
from torch.optim import Adam

# from mask_generators import ImageMaskGenerator
from models.vaeac.nn_utils import ResBlock, MemoryLayer, SkipConnection
from models.vaeac.prob_utils import normal_parse_params, GaussianLoss
...
#     return normal_parse_params(params).sample()
...
proposal_network = nn.Sequential(
    ...
    ResBlock(8, 8), ResBlock(8, 8), ResBlock(8, 8), ResBlock(8, 8),
    nn.AvgPool2d((2,1),(2,1)), nn.Conv2d(8, 16, 1),
    ResBlock(16, 8), ResBlock(16, 8), ResBlock(16, 8), ResBlock(16, 8),
    nn.AvgPool2d((2,1),(2,1)), nn.Conv2d(16, 32, 1),
...
#     ResBlock(128, 64), ResBlock(128, 64),
    ...
    ResBlock(16, 8), ResBlock(16, 8), ResBlock(16, 8), ResBlock(16, 8),
    nn.Conv2d(16, 8, 1), nn.Upsample(scale_factor=(2,1)),
    ...
    ResBlock(8, 8), ResBlock(8, 8), ResBlock(8, 8), ResBlock(8, 8),
    MemoryLayer('#0', True), nn.Conv2d(11, 8, 1),
    ResBlock(8, 8), ResBlock(8, 8), ResBlock(8, 8), ResBlock(8, 8),
    nn.Conv2d(8, 2, 1),
)
